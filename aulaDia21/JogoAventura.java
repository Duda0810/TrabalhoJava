...
public class JogoAventura {
    ...
    private static void jogo(Personagem personagem, Scanner scanner) {
        while (personagem.getVida() > 0) {
            System.out.println("\nEscolha uma ação:");
            System.out.println("1 - Ir para a cidade vizinha");
            ...
            switch (escolha) {
                case 1:
                    irParaAcidadeVizinha(personagem, scanner);
                    break;
                case 2:
    ...
    private static void irParaAcidadeVizinha(Personagem personagem, Scanner scanner) {
        System.out.println("Você chegou na cidade vizinha.");

        System.out.println("1 - Comprar uma arma");
        System.out.println("2 - Falar com o mestre da cidade");
    ...
    private static void comprarArma(Personagem personagem, Scanner scanner) {
        ...
        System.out.println("2 - Arco (para Feiticeiro)");
        ...
        if (escolhaArma == 1 && !(personagem instanceof Guerreiro)) {
        ...
        } else if (escolhaArma == 2 && !(personagem instanceof Feiticeiro)) {
            System.out.println("Você não pode comprar a Varinha magica. Apenas Feiticeiros podem equipá-lo.");
            ...
            switch (escolhaArma) {
                case 1:
                    ...
                    break;
                case 2:
                    personagem.usarArma("Varinha magica");
                    break;
                case 3:
    ...
    private static void enfrentarMonstro(Personagem personagem, Scanner scanner) {
        System.out.println("Você se deparou com um monstro. Deseja lutar?");
